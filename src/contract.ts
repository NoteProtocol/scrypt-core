...
import { ContractEntity, getFullFilePath,  OpCode, StaticEntity } from './compilerWrapper';
import {
  ABICoder, ABIEntity, AliasEntity, Arguments, bsv, buildContractCode, checkNOPScript, DEFAULT_FLAGS, FunctionCall, hash160, isArrayType,  resolveType, Script, StructEntity, subscript, TypeResolver
} from './internal';
 ...
 */
  ...
  public fmtError(err: {
    ...
    const error = `VerifyError: ${err.error}, fails at ${new bsv.Opcode(failedOpCode)}\n`;
...
export function buildContractClass(artifact: Artifact): typeof AbstractContract {
